...
```md
         ...
         |                                       |                        
┌─────────────────────────────┐   ┌────────────────────────────┐
│   RaydiumAmmMonitor         │   │    BinanceMonitor          │
│-----------------------------│   │----------------------------│
│ - WebSocket msg (Solana)    │   │ - WebSocket msg Binance    │
│ - update pool state -> price│   │ - update orderbook snapshot│
│ - notify all listeners      │   | - notify all listeners     │
└─────────────────────────────┘   └────────────────────────────┘

┌──────────────────────────────────┐   ┌──────────────────────────────────────────┐
│ SimpleArbitrageDetector          │   │ OrderBookArbitrageDetector               │
│----------------------------------│   │------------------------------------------│
│ - subscribes to both venues      │   │ - subscribes to both venues              │
│ - iterate configured trade sizes │   │ - use live order book ask/bids quantities│
│ - callback on opportunities      │   │ - callback on opportunities              │
└──────────────┬───────────────────┘   └──────────────┬───────────────────────────┘
               │                                      │
               └──────────────┬───────────────────────┘
                              │
